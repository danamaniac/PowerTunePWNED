...
if [ -d /home/root ]; then
    ...
    if [ -d /home/Recoverysrc ]; then
        ...
        git clone https://github.com/danamaniac/OGdash.git /home/pi/Recoverysrc
        cd /home/pi/Recoverysrc
        ./updateRecovery.sh
    fi
    ...
    if [ -d /home/pi/src ]; then
        ...
        echo "Create source directory and clone OG DASH Repo"
        mkdir /home/pi/src
        git clone https://github.com/danamaniac/OGdash.git /home/pi/src
        cd src
        ./updatedaemons.sh
        ./updateUserDashboards.sh
    fi
    ...
    # Compile OG DASH
    cd /home/pi/build
    echo "Compiling OG DASH ... go grab a Coffee"
    qmake /home/pi/src
    make -j4

    # Check if the OG DASH executable exists in the build folder
